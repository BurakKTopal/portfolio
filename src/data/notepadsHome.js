...
notepadsProgramming.addHead({ id: "programming", title: "Programming", textContent: testContent, button: true });
// notepadsProgramming.addTail({ id: "programming2", title: "Programming for life", textContent: testContent, button: true });

// Professional life
const notepadsProfessionalLife = new DoubleLinkedList();
notepadsProfessionalLife.addHead({ id: "professionalLife", title: "Professional Life", textContent: testContent, button: true });


// Math and physics combining
const notepadsMathAndPhysics = new DoubleLinkedList();
notepadsMathAndPhysics.addHead({ id: "bachelorThesis", title: "Bachelor Thesis", otherContent: testContent, button: true });
...
const mathAndPhysicsIntroContent = (
    <>
        <div id="mathematics-and-physics-intro">
            <p>
                Since I was young, I've always had a passion for creating and observing how things work. Initially, pursuing an engineering degree seemed like the perfect fit, and everyone around me agreed.
                However, everything changed during my last year of high school.
            </p>
        </div>
        <p>
            Since Languages aren't my strongest part, Mathematics and Physics became my beloved subjects. During summer breaks, I eagerly awaited the delivery of my books to dive deeper into Mathematical concepts.
            However, I never considered pursuing these subjects further in college, as I associated Mathematics solely with teaching high school—a path that didn't appeal to me. Engineering had been my childhood dream, and I intended to pursue it.
        </p>
        <p>
            That all changed during the 'thematic days' in my final year of high school. Despite already dedicating eight hours a week to Mathematics by my studies, I chose to delve deeper into 'logic'. Those three days became the highlight of my year.
            While it wasn't the complex proofs I'd encounter later, the abstract nature and rigorous approach sparked something within me. It was then that I realized pursuing engineering might not fulfill my desire for theoretical rigor and abstract problem-solving.
            As for future career prospects, I was uncertain, but following my passion and dreams seemed like the right path forward.
        </p>
        <p>
            In 2021, I enrolled in Mathematics. By the end of my first semester, I qualified for the 'TWIN-track', allowing me to study additional Physics subjects alongside Mathematics.
            This dual-degree track, however, didn't require me to complete 360 credits in three years due to overlapping coursework. I eventually completed 245 credits, thanks to exemptions granted based on my performance in related subjects.
        </p>
        <p>
...
//     <div id="mathematics-and-physics-intro">
//         <p>
//         Since I was little, I loved making things, creating, seeing and observing how my invention roles out. People that knew me also motivated me that going
//         for an engineering study in college, will be a perfect fit and I didn't argue, because it was. That all changed in my last year of high school.
//         </p>
//     </div>
//     <p>
//         As a person who isn't that eloquent, I found my getaway with Mathematics and Physics. During the summer holidays, the only thing I could think about was when my books will
//         be delivered so that I could enrich my Mathematical knowledge. But during my years of high interest and love, I'd never considered as a study I would further delve in to during
//         my college years because in my head, Mathematics was equal to ending up being a teacher at high school, which wasn't appealing at all. Furthermore, engineering was my child's dream,
//         and I would simpely persue that, right?
//     </p>
//     <p>
//         Well, that all changed when we had so-called 'thematic days' (in Dutch: 'verdiepingsdagen') in my last year at high school. Apparently 8 hours a week of Mathematics wasn't enough
//         for me because I'd chosen 'logic' as my subject to further research into. The three days that I worked on that were maybe the best of that year. In hindsight, it was simple set theory, logic
//         tables discussion and by using these tables to check whether two statements are equal or not. It may have not been the complex and rigorous proofs I will be seeing in the
//         subsequent years, but nonetheless, the abstractness and rigor to which we have approached these problems really sparked something in me. It was that day that my ever-lasting child dream to
//         go into engineering, wasn't the right way to go; by doing so, I would lose the satisfying rigor and theory and only apply it to more practical situations. What about future jobs?
//         I didn't have a clue to be honest, though following your passion and dreams will guide you along the line.
//     </p>
//     <p>
//         In 2021, I started with Mathematics. After my first semester, I was eligible to follow the 'TWIN-track', which means that you pick up
//         additional Physics subjects, besides your Mathematics subjects to eventually receive a double degree at the end of the three years. This does not mean that
//         I have taken 360 credit points in three years, though! Due to the close nature of these fields, you can receives exemptions at some Physics subjects, based on what
//         you got in a similar fashion at Mathematics (or vice versa). eventually, it boiled down to 245 credit points.
//     </p>
//     <p>
//         In the two notepads below I will present my experience of this track, together with providing some academic results, which parts I found difficult, more interesting, or precisely not.
//     </p>
// </>
